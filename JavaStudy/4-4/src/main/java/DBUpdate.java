...
public class DBUpdate {
    ...
    private static final String JDBC_CONNECTION = "jdbc:postgresql://localhost:5432/SHOHIN";
    /** ・ユーザー名 */
    // 問② データベースのユーザー名を定数にしなさい。
    private static final String USER = "postgres" ;
    /** ・パスワード */
    // 問③ データベースのパスワードを定数にしなさい。
    private static final String PASS = "yato1501";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String SQL = "UPDATE tb_shohin SET SHOHIN_NAME = '商品20'\r\n "
                    + " WHERE shohin_id = '020' ";
