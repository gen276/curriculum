...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        Map<Integer , String> shohinList = new HashMap<>();
        ...
        /*
         * shohinList内の「2」と格納されている「豚肉」の値と180を関連付け,shopMapに格納している
         *
         */
        ...
        for (Map.Entry<Integer , String> entry : shohinList.entrySet()) {
            System.out.println(entry.getValue() + "=" + shopMap.get(entry.getValue())+"円になります！");
        }
