...
-- select distinct shopname , goodsname , quantity from stocks
	inner join shop on stocks.shopcode = shop.shopcode
	inner join goods on stocks.goodscode = goods.goodscode;
